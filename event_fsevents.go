...
var osestr = map[Event]string{
	...
	FSEventsCreated:         "notify.FSEventsCreated",
	FSEventsRemoved:         "notify.FSEventsRemoved",
	FSEventsInodeMetaMod:    "notify.FSEventsInodeMetaMod",
	FSEventsRenamed:         "notify.FSEventsRenamed",
	FSEventsModified:        "notify.FSEventsModified",
...
var osstre = map[string]Event{
	"notify.FSEventsMustScanSubDirs": FSEventsMustScanSubDirs,
	"notify.FSEventsUserDropped":     FSEventsUserDropped,
	"notify.FSEventsKernelDropped":   FSEventsKernelDropped,
	"notify.FSEventsEventIdsWrapped": FSEventsEventIdsWrapped,
	"notify.FSEventsHistoryDone":     FSEventsHistoryDone,
	"notify.FSEventsRootChanged":     FSEventsRootChanged,
	"notify.FSEventsMount":           FSEventsMount,
	"notify.FSEventsUnmount":         FSEventsUnmount,
	"notify.FSEventsCreated":         FSEventsCreated,
	"notify.FSEventsRemoved":         FSEventsRemoved,
	"notify.FSEventsInodeMetaMod":    FSEventsInodeMetaMod,
	"notify.FSEventsRenamed":         FSEventsRenamed,
	"notify.FSEventsModified":        FSEventsModified,
	"notify.FSEventsFinderInfoMod":   FSEventsFinderInfoMod,
	"notify.FSEventsChangeOwner":     FSEventsChangeOwner,
	"notify.FSEventsXattrMod":        FSEventsXattrMod,
	"notify.FSEventsIsFile":          FSEventsIsFile,
	"notify.FSEventsIsDir":           FSEventsIsDir,
	"notify.FSEventsIsSymlink":       FSEventsIsSymlink,
}
